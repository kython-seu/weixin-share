...
public class APPConfig extends JFinalConfig {
	...
	public void configRoute(Routes me) {
		//for test
		me.add("/share", HelloControl.class);
		me.add("/wxshare", WeshareController.class);
		// 微信
	...
	public void configPlugin(Plugins me) {
		...
		arp.addMapping("ads","id",Ad.class);
		arp.addMapping("statistics","id",Statistics.class);
		me.add(arp);
		// 配置ActiveRecord插件
		/*DruidPlugin druidPlugin = createDruidPlugin();
		me.add(druidPlugin);
